...
namespace erminas.SmartAPI.Exceptions
{
    ...
    public class RQLException : SmartAPIException
    {
        ...
        private readonly List<Tuple<string, string>> _errorCodes = new List<Tuple<string, string>>
                                                                       {
                                                                           Tuple.Create("Please Login","The user session has timed out or the Login GUID is no longer valid. Please login again."),
                                                                           ...
                                                                           Tuple.Create("RDError3","The license key is not correct. An error which could not be classified has occurred during the check."),
                                                                           ...
                                                                           Tuple.Create("RDError7","License is a cluster license. This error message is no longer supported beginning with CMS 6.0."),
                                                                           ...
                                                                           Tuple.Create("RDError15","The serial number of the license key is different from the serial number of the previous license key."),
                                                                           ...
                                                                           Tuple.Create("RDError110","The user does not have the required privileges to execute the RQL. The cause of this situation may be that the logon GUID or session key has expired or the session has timed out."),
                                                                           ...
                                                                           Tuple.Create("RDError3032","You have tried to delete a content class on the basis of which pages have already been created."),
                                                                           ...
                                                                           Tuple.Create("RDError16997","You cannot delete the content class. There are pages which were created on the basis of this content class in other projects.")
                                                                       };
        #endregion
        ...
        public RQLException(string server, string reason, string responseXML)
        {
            ...
            var msg = _errorCodes.LastOrDefault(x => reason.Contains(x.Item1));
