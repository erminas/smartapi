...
namespace erminas.SmartAPI.Utils
{
    ...
    /// </summary>
    /// <example>
    ///   In this example the caching for the ContentClasses list in a project gets disabled and then temporarily enabled for a specific scope through the use of a CachingContext. <code>project.ContentClasses.IsCachingEnabled = false;
    ///                                                                                                                                                                               ...
    ...
    internal class CachingContext<T> : IDisposable where T : class
    {
