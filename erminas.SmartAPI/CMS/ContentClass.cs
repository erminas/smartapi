...
namespace erminas.SmartAPI.CMS
{
        ...
        ContentClass : PartialRedDotObject
    {
        ...
        public ContentClass(Project project, XmlNode xmlNode)
            : base(xmlNode)
        {
            Project = project;
        ...
        public CCEditableAreaSettings EditableAreaSettings
        {
            get
            {
                if (_editableAreaSettings == null)
                {
                    ...
                    XmlNode node = xmlDoc.GetElementsByTagName("SETTINGS")[0];
                    if (node == null)
                    {
                ...
                if (_elements == null)
                {
                    ...
                    using (new LanguageContext(Project))
                    {
                        foreach (var curLanguage in Project.LanguageVariants)
                        {
                            ...
                            XmlNode xmlNode = xmlDoc.GetElementsByTagName("ELEMENTS")[0];
        ...
        public TemplateVariantList TemplateVariants
        {
            get
            {
                if (_templateVariants == null)
                {
                    ...
                    XmlNode xmlNode = xmlDoc.GetElementsByTagName("TEMPLATE")[0];
        ...
        private List<CCVersion> GetVersions()
        {
            ...
            return (from XmlNode curVersion in versionNodes
        ...
        public ILookup<ProjectVariant, TemplateVariant> GetProjectVariantAssignments()
        {
            ...
            try
            {
                ...
                return (from XmlNode curElement in xmlDoc.GetElementsByTagName("TEMPLATEVARIANT")
                        select
                            new
                                {
                                    projectVariant =
        ...
        public class CCEditableAreaSettings : AbstractAttributeContainer
        {
            ...
            public CCEditableAreaSettings(ContentClass parent, XmlNode node)
                : base(node)
            {
        ...
        public class CCVersion : RedDotObject
        {
            ...
            public CCVersion(ContentClass parent, XmlNode node)
                : base(node)
            {
                ContentClass = parent;
            }
