...
{
    public abstract class AbstractContentClassPreassignable : ContentClassElement, IContentClassPreassignable
    {
        protected AbstractContentClassPreassignable(ContentClass contentClass, XmlElement xmlElement)
