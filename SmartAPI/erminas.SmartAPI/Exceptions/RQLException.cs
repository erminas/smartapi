        ...
        private readonly List<Tuple<string, string>> _errorCodes = new List<Tuple<string, string>>
            {
                ...
                Tuple.Create("RDError102", "Login and sessionkey is missing."),
                Tuple.Create("RDError103", "The user login with cookie data is invalid."),
                Tuple.Create("RDError104", "The user login name or password is not correct."),
